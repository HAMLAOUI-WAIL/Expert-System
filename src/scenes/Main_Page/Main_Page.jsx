...
export default function Main_Page() {
  ...
  useEffect(()=>{
    fetch("https://localhost:8080/popular").then(res=>res.json()).then(res=>
    {setBookList(prev=>(res.data))})
  },[])
        ...
        <div style={{display:'flex'}}>
            <div className='LeftMain'>
                ...
                <div style={{margin:'1rem 0'}}>
                    <Link to={localStorage.getItem("booksData")?"/journey":"/Form_after"}>
